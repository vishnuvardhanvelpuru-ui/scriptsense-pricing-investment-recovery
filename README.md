# ScriptSense â€” B2B Enterprise Pricing & Investment Recovery Strategy
...
## Key findings
Current monthly revenue is â‚¹9.53 lakh, direct service cost â‚¹3.46 lakh, gross profit â‚¹6.07 lakh and gross margin 63.70%. Total monthly company cost is â‚¹8.46 lakh including â‚¹5 lakh overhead. Operating surplus is â‚¹1.07 lakh. Average annualized contract value is â‚¹3.1755 lakh.

C012 loses â‚¹5,000/month before overhead and C024 earns only â‚¹400. The five largest accounts provide 25.72% of revenue. 17 contracts have a margin, usage or discount review signal, which is not proof of willingness to pay.

## Pricing strategy and recovery
Test monthly list bases of â‚¹12,960 / â‚¹27,500 / â‚¹56,000 with 25 / 80 / 250 included script-analysis runs and â‚¹200 / â‚¹150 / â‚¹100 overage. Preserve existing base discounts in the model. These rates are hypotheses for renewal pilots, not externally validated optimal prices.

| Scenario | Revenue â‚¹ lakh/month | Gross profit â‚¹ lakh/month | Gross margin | Surplus â‚¹ lakh/month | Payback years |
|---|---:|---:|---:|---:|---:|
